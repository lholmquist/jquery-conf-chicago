...
Q.Sprite.extend("Player",{
  ...
  resetLevel: function() {
    Q.stageScene(Q.stage().scene.name);
    this.p.strength = 100;
...
Q.Sprite.extend("Door", {
  ...
  findLinkedDoor: function() {
    ...
    loadNextLevel(this.p.nextLevel);
...
Q.loadTMX("level1.tmx, level2.tmx, intro.tmx, collectables.json, doors.json, enemies.json, fire.mp3, jump.mp3, heart.mp3, hit.mp3, coin.mp3, player.json, player.png", function() {
